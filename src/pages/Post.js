...
function Post({ user }) {
  ...
  return (
    <>
      { showLoginbox
      && (
        <div className="Loginbox-popup-container">
          <div className="Loginbox-popup-box">
            <div onClick={() => setShowLoginbox(false)} className="Loginbox-popup-box-close">
              <img src="https://cdn-icons-png.flaticon.com/128/1828/1828744.png" alt="close" />
            </div>
            <div className="Loginbox-popup-title">請先登入進行互動!</div>
            <Loginbox />
          </div>
        </div>
      )}
